                    ...
                    <div class="card shadow-lg border-0 mt-5">
                        <div class="card-header bg-warning d-flex align-items-center">
                            ...
                            <div class="ms-auto d-flex gap-2">
                                <a href="<?= $baseURL ?>admin/create" class="btn btn-primary btn-sm">Thêm sản phẩm</a>
                                <a href="<?= $baseURL ?>admin" class="btn btn-light btn-sm"><i class="fas fa-arrow-left"></i> Quay lại</a>
                            </div>
                        </div>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($productList as $item): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= $baseURL ?>admin/edit?ProductID=<?= htmlspecialchars($item['id']) ?>" class="btn btn-sm btn-primary" title="Sửa sản phẩm">
                            ...
                            <?php if ($totalPages > 1): ?>
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-center">
                                        <?php if ($page > 1): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=<?= $page - 1 ?>" aria-label="Previous">«</a>
                                            </li>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($page < $totalPages): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=<?= $page + 1 ?>" aria-label="Next">»</a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </nav>
