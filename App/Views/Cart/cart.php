...
<head>
    ...
    <link href="<?= $base ?>assets/css/cart.css" rel="stylesheet"> <!-- Liên kết CSS mới -->
    <!--[if lt IE 9]>
    <script src="<?= $base ?>assets/js/html5shiv.js"></script>
    <script src="<?= $base ?>assets/js/respond.min.js"></script>
    <![endif]-->       
    <link rel="shortcut icon" href="<?= $base ?>assets/images/ico/favicon.ico">
